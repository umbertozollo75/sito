...
<html lang='en-US'>
  ...
  <body class="home">
    ...
    <header class="header-head">
      <div class="rd-navbar-wrap rd-navbar-wrap-new" style="height: 232px;">
        ...
        <div class="row">
          <div class="col-md-8">
            <div class="news-container">
              ...
              <article id="2" class="news-item blog-col-1">
                <div class="post-wrap">

                  <div class="post-content">
                    <!-- title -->
                    <h3 class="post-title entry-title">
                      <a href="#">Come creare un blog Jamstack multilingua con Nuxt.js e Strapi CMS</a>
                    </h3>
                    <!-- end title -->
                    <!-- excerpt -->
                    ...
                    <div class="post-details-wrap clearfix">
                      ...
                      <span class="screen-reader-text">
                        <span class="vcard author">
                          <span class="fn">
                            <a href="#" title="Posts by Andrea Stagi" rel="author">Andrea Stagi</a>
                          </span>
                        </span>
                      </span>
                      <!-- end author (hidden) -->
              ...
              <article id="1" class="news-item blog-col-1">
                <div class="post-wrap">
                  <div class="post-content">
                    <!-- title -->
                    <h3 class="post-title entry-title">
